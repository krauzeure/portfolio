  ...
  return (
    <main className="main-about">
        ...
        <div className="home-buttons">
          <Link className="home-cta resume-cta primary-cta" to="/projects">→ {langValue.lang ? frenchCopy.home.primarycta : englishCopy.home.primarycta}</Link>
          <Link className="home-cta projects-cta secondary-cta" to="/resume">→ {langValue.lang ? frenchCopy.home.secondarycta : englishCopy.home.secondarycta}</Link>
        </div>
